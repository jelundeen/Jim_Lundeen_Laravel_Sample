...
use App\Models\EventSummaryMonthly;
use Maatwebsite\Excel\Concerns\Exportable;
use Maatwebsite\Excel\Concerns\FromQuery;
use Maatwebsite\Excel\Concerns\WithHeadings;


class LiveStreamUniqueMonthlyExport implements FromQuery, WithHeadings
{
    use Exportable;
    ...
    public function query()
    {
        ...
        $query = EventSummaryMonthly::query()
            ->selectRaw("
            ...
            ->fromRaw('events_summary_monthly AS e')
