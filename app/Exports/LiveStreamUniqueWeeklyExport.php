...
use App\Models\EventSummaryWeekly;
use Maatwebsite\Excel\Concerns\Exportable;
use Maatwebsite\Excel\Concerns\FromQuery;
use Maatwebsite\Excel\Concerns\WithHeadings;


class LiveStreamUniqueWeeklyExport implements FromQuery, WithHeadings
{
    use Exportable;
    ...
    public function query()
    {
        ...
        $query = EventSummaryWeekly::query()
            ->selectRaw("
            ...
            ->fromRaw('events_summary_weekly AS e')
